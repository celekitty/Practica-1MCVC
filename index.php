...
<html lang="es">
<head>
    <title>MARIA CELESTE VANEGAS CEA</title>  
        ...
        <div class="row align-items-center h-100%">
            ...
            <div class="col">
                <div class="align-items-center">
                    <p> Maria Celeste Vanegas Cea (mochi)</p>
                                  ...
                                  <td>
                                        <div class ="form-row">
                                            <div class="form-group col-md-6"> 
                                                ...
                                                <input type="tex" class="form-control" name="txt_usuario" id="txt_usuario" maxlength="15" aria-describedby="txt_user_help" required  />
